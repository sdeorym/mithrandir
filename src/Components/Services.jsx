    ...
    const serve = [
        {
            ...
            "content": (<>
                            Diagnostic rapide des risques et problèmes potentiels, avec des recommandations pour réduire la dette technique.
                        </>)
        }, 
        {
            "id" : "1",
            ...
            "content": (<>
                            Recommandations pragmatiques pour mettre en œuvre des architectures qui évoluent douce et organiquement, guidées par le besoin réel plutôt que par la mode.
                        </>)
        }, 
        {
            "id" : "2",
        ...
        },
        {
            ...
            "content": (<>
                            Orienté à projets complexes, en difficulté ou en retard, toujours avec une vision de l’impact business (performance, coûts, délais).</>)
        },
        {
            "id" : "4",
            "service": (<>Analyse et remise en maîtrise de systèmes non documentés</>),
            "content": (<>
                            Comprendre, documenter et avancer logiciels legacy dont la connaissance s’est perdue avec le temps.</>)
        }, 
        {
            "id" : "5",
        ...
        }, 
        {
            "id" : "6",
            "service": (<>
                            Mise en œuvre de méthodologies et <i>bons pratiques</i>, <i>Code review</i></>),
            "content": (<>
                            Amélioration de la capacité collective à livrer avec fiabilité, prévisibilité et pragmatisme.</>)
        },
        {
            "id" : "6",
